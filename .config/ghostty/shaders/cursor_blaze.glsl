...
// Base color - change this to adjust all cursor colors
const vec3 BASE_COLOR = vec3(1.0, 0.85, 0.3); // warm yellow

const vec4 TRAIL_COLOR = vec4(BASE_COLOR, 1.0);
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(BASE_COLOR * 0.7, 1.0); // darker variant
